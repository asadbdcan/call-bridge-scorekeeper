                  ...
                  <div key={playerId} className="bg-gradient-to-r from-emerald-50 to-cyan-50 rounded-2xl shadow-md p-2 border-l-4" style={{ 
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1 ml-auto flex-shrink-0">
                        ...
                        <button 
                          onClick={() => {
                            const playerRound = currentRound.find(r => r.playerId === playerId);
                            if (playerRound) {
                              handleDirectInput(playerId, 'scored', playerRound.call);
                            }
                          }}
                          disabled={!callsLocked}
                          className="w-6 h-6 bg-gradient-to-br from-emerald-400 to-cyan-400 rounded-full flex items-center justify-center hover:from-emerald-500 hover:to-cyan-500 hover:shadow-md active:scale-90 transition-all shadow-sm disabled:opacity-20 disabled:cursor-not-allowed disabled:from-gray-200 disabled:to-gray-300"
                          title="Copy call to score">
